...
class ServerAPI
{
     ...
     * 设置频道录制状态
     * @param $cid
     * @param int $needRecord
     * @param string $format
     * @param int $duration
     * @return array
     */
    public function setChannelRecordStatus($cid, $needRecord = 1, $format = 'mp4', $duration = 90)
    {
     ...
     * @return array
     */
    public function getChannelVideoList($cid)
    {
     ...
     * @return array
     */
    public function channelListPause($cidList){
     ...
     * @return array
     */
    public function channelListResume($cidList){
     ...
     * @return array
     */
    public function channelResetRecord($cid){
        $url = 'https://vcloud.163.com/app/channel/resume';
        $data = [
            'cid' => $cid
        ];
